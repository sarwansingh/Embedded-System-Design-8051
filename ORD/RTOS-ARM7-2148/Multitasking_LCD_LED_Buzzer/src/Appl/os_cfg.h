...
#define OS_ISR_PROTO_EXT          1    /* Prototypes for the following functions are declared in APP:  */
                                       /*     OSStartHighRdy()                                         */
                                       /*     OSCtxSw()                                                */
                                       /*     OSIntCtxSw()                                             */
...
#define OS_FLAGS_NBITS           16    /* Defines the width of OS_FLAGS (MUST be 8, 16 or 32)          */
...
#define OS_TMR_CFG_WHEEL_SIZE     2    /*     Size of timer wheel (#Entries)                             */
#define OS_TMR_CFG_TICKS_PER_SEC  2    /*     Rate at which timer management task runs (Hz)              */
